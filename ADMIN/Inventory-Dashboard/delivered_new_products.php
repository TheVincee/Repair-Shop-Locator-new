    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            function loadDeliveredNewProducts() {
                ...
                xhr.open('GET', 'status_operations.php?action=listByStatus&status=Delivered New', true);
                xhr.onload = function() {
                    if (this.status == 200) {
                        ...
                        if (!data.error) {
                            ...
                            document.getElementById('deliveredNewProductsTableBody').innerHTML = html;
                        } else {
                            alert(data.error);
                        }
                    }
            ...
            // Load delivered new products initially
