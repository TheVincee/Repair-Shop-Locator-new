...
<body>
    ...
    <script>
        $(document).ready(function () {
            ...
            function fetchAppointments() {
                $.ajax({
                    ...
                    error: function (jqXHR, textStatus, errorThrown) {
                        ...
                        $('#appointmentsTableBody').html('<tr><td colspan="12" class="text-center">Failed to load data.</td></tr>');
                    }
                });
            }
            ...
            $('#appointmentsTableBody').on('click', '.btn-view', function () {
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        ...
                        $('#modalCarMake').text(data.carmake);
                        $('#modalCarModel').text(data.carmodel);
